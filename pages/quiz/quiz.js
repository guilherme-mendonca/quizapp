                ...
                <section class="alternativas">
                    <form action="">
                        <label for="alternativa_a">
                            <input type="radio" id="alternativa_a" name="altenativa">
                        ...
                        <label for="alternativa_b">
                            <input type="radio" id="alternativa_b" name="altenativa">
                        ...
                        <label for="alternativa_c">
                            <input type="radio" id="alternativa_c" name="altenativa">
                        ...
                        <label for="alternativa_d">
                            <input type="radio" id="alternativa_d" name="altenativa">
