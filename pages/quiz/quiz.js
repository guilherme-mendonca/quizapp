                ...
                <section class="alternativas">
                    <form action="">
                        ...
                        <label for="alternativa_b">
                            <input type="radio" id="alternativa_b" name="altenativa" value="${alterarSinais(quiz.questions[pergunta-1].options[1])}">
                        ...
                        <label for="alternativa_c">
                            <input type="radio" id="alternativa_c" name="altenativa" value="${alterarSinais(quiz.questions[pergunta-1].options[2])}">
                        ...
                        <label for="alternativa_d">
                            <input type="radio" id="alternativa_d" name="altenativa" value="${alterarSinais(quiz.questions[pergunta-1].options[3])}">
